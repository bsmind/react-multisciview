...
import { isArrayOfString, hexToRGBA } from "../utils";
import { scaleSequential, scaleLinear, interpolateViridis } from "d3-scale";
...
class ColorLegend extends React.Component {
    ...
    getDrawRegion = () => {
    	...
    	let width, height, barWidth, barHeight, transform;
    	const x = canvasDim.width - margin.right - legendWidth;
    	const y = margin.top;
...
ColorLegend.propTypes = {
	...
	shared: PropTypes.shape({
		handleZAxisSelect: PropTypes.func,
		handleZAxisSelectEnd: PropTypes.func,
